...
export default {
    ...
    data() {
        return {
            ...
            radios: '',
            tableData: [{
                date: 'memcached.serverlist',
                name: 'localhost:11211',
                address: 'io.github.xdiamond/xdiamond-cliente-example/0.0.1'
            }, {
                date: 'zookeeper.serverlist',
                name: 'localhost:11211',
                address: 'io.github.xdiamond/xdiamond-cliente-]example/0.0.1'
            }],
            datalistz: [{
    ...
    mounted() {
        setSessionStore('defaultActive', '/dcp/monitor/configurationManagement');
