<template>
    <div class="dept-management">
        <dcp-dialog id="add_dialog" ref="addDialog" :width="900" :height="420" :title="title">
            <div slot="dialog_body" style="padding:40px;">
                <el-form :model="ruleForm" :rules="rules" ref="deptForm" class="dep-form" :label-width="labelWidth">
                    <el-row :gutter="20">
                        ...
                        <el-col :span="12">
                            <el-form-item label="部门编码" prop="departmentCode">
                                <el-input class="form-input" v-model="ruleForm.departmentCode" :disabled="this.state === 'view'"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="部门名称" prop="departmentName">
                                <el-input class="form-input" v-model="ruleForm.departmentName" @change="onChange" :disabled="this.state === 'view'"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="所属机构">
                                <el-select v-model="ruleForm.theOrganizationId" placeholder="请选择" class="form-select" @change="organChange" :disabled="this.state === 'view'">
                        ...
                        <el-col :span="12">
                            <el-form-item label="上级部门名称">
                                <el-select v-model="ruleForm.superiorDepartment" placeholder="请选择" class="form-select" :disabled="this.state === 'view'" @change="departmentChange">
                        ...
                        <el-col :span="12">
                            <el-form-item label="详细地址">
                                <el-cascader ref="parRegion" class="form-input" expand-trigger="click" filterable change-on-select clearable 
                                    :options="allRegion" v-model="ruleForm.detailedAddressId" placeholder="" style="width: 100%;"></el-cascader>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="部门全路径">
                                <el-input class="form-input" v-model="ruleForm.path" :disabled="this.state === 'view'"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12" v-if="this.state === 'view'">
                            <el-form-item label="创建时间">
                                <el-input class="form-input" v-model="ruleForm.addDate" disabled></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
...
export default {
    ...
    methods: {
        ...
        open(title = null, type = 'add', row) {
            ...
            if (addrType !== 'Array') {
                if (addrType === 'Number') {
                    this.ruleForm.detailedAddressId.push(detailedAddressId);
                }
            } else {
                this.ruleForm.detailedAddressId = detailedAddressId;
            }
        
            // 延迟加载，为了等组件挂载到dom后再出发select的change事件
            setTimeout(() => {
                this.ruleForm.theOrganizationId = theOrganizationId + '';
                this.ruleForm.superiorDepartment = superiorDepartment + '';
            }, 0);
        },
        onChange() {
            // 部门名称改变，更改路径
            var paths = [this.organ, this.lastDep, this.ruleForm.departmentName];
            this.ruleForm.path = this.getFullPath(paths);
        },
        getFullPath(paths) {
            // 获取全路径
        ...
        organChange(select) {
            ...
            // 更新全路径
            this.ruleForm.path = this.getFullPath([this.organ, this.lastDep, this.ruleForm.departmentName]);
        ...
        getDepartmentData(select) {
            ...
            listDepartmentInfo(select)
                .then(res => {
                    ...
                    if (mode === 'add') {
                        this.lastDep = '';
                        this.ruleForm.superiorDepartment = '';
                    }
                    // 成功返回
                    if (code === 200) {
                        // todo: isOrg?
        ...
        closeDialog(formName) {
            ...
            this.ruleForm.departmentCode = ''; // 部门编码
            this.ruleForm.departmentName = ''; // 部门名
            this.ruleForm.theOrganizationId = ''; // 机构id
            this.ruleForm.superiorDepartment = ''; // 上级部门id
            this.ruleForm.detailedAddressId = []; // 详细地址id          
            this.ruleForm.addDate = '';
            this.ruleForm.id = '';
