<template>
    <div class="sys-region">
        ...
        <dcp-import ref="region_import" title="区域导入" :isStep="false" importTitle="区域" downloadAddress="/Batch/v1.0/DownDataSourceTemplateFile/区域" serverAddress="/Batch/v1.0/importAreaData" :isTest="false"></dcp-import>
