<template>
    <div class="sys-tag">
        ...
        <dcp-import ref="import" title="标签导入" :isStep="false" importTitle="标签" downloadAddress="/Batch/v1.0/DownDataSourceTemplateFile/标签" serverAddress="/Batch/v1.0/importTagInfoData" :isTest="false"></dcp-import>
